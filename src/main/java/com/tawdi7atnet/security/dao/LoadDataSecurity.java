...
import com.tawdi7atnet.security.service.RoleService;
...
public class LoadDataSecurity {
	...
	@Bean
	CommandLineRunner load(UserService userService, RoleService roleService, ProfileService profileService) {
		return args -> {
